...
$idvieclam 		= urldecode( (isset($_POST['idvieclam'])?$_POST['idvieclam']:"" ) ); 
	...
	if(/*kiemtraungdung()*/1)
	{
		$query 	= " select d.ten, d.ngaysinh, b.*, e.url from (SELECT idnguoidung FROM `kt_dangkyviec` WHERE idvieclam = '$idvieclam' and duyet = 0) as a left join kt_nguoidung_timviec b on a.idnguoidung = b.idnguoidung left join oc_nguoidung d on a.idnguoidung = d.idnguoidung left join oc_hinhanh e on b.idhinhanh = e.idhinh ";
				//echo $query;
